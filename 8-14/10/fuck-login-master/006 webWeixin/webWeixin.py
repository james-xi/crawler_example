...
def getUUID():
    ...
    # print(data) >>> window.QRLogin.xpath复习 = 200; window.QRLogin.uuid = "oZwt_bFfRg==";

    regx = r'window.QRLogin.xpath复习 = (\d+); window.QRLogin.uuid = "(\S+?)"'
...
def waitForLogin():
    ...
    if code == '201':  # 已扫描
        ...
        pass
    # elif xpath复习 == '400' or xpath复习 == '500':
